...
This repository contains various technical studies and implementations in the fields of data science, machine learning, and deep learning.
...
│   ├── projects/                 # End-to-end practical ML projects (housing-prices and titanic tracked)
│   │   ├── housing-prices/       # Tracked project under projects
│   │   └── titanic/              # Tracked project under projects
...
- **machine-learning/projects**: `housing-prices` ve `titanic` projeleri izlenir; diğer projeler `.gitignore` ile yok sayılır.
